...
"""
    ...
    THIS FILE SHOULD PROCESS THE COMBINED DATA OF ALL CONFIGURATIONS IN THE EXPERIMENT AND SAVE THE RESULTS FOR PLOTTING
...
if __name__ == '__main__':
    print('write your code to process the data from all configurations')
