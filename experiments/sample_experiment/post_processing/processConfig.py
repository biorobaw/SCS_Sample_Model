...
from BinaryFiles import *
from VariableLoader import *

""" 

    MODIFY THIS FILE AS NECESSARY
    THIS FILE SHOULD PROCESSES THE LOGS GENERATED BY ALL SIMULATIONS OF A CONFIGURATION
...
if __name__ == '__main__':
    print('write your code to process all data from a single configuration')
    # argv[1] = base folder
    # argv[2] = config
    # if len(sys.argv) > 2:
